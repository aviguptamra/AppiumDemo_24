...
public class Install_Test_X_Android_APK_On_VirtualDevice_4 {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException {
		...
		driver.findElement(AppiumBy.id("com.twitter.android:id/name_edit_text")).sendKeys("ShriLaxmi@gmail.com");
		
		Thread.sleep(3000);
		
		driver.findElement(By.id("com.twitter.android:id/phone_or_email_edit_text")).sendKeys("ShriLaxmi@1234");
