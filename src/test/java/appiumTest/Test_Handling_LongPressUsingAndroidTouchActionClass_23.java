...
public class Test_Handling_LongPressUsingAndroidTouchActionClass_23 {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException {
        ...
        touch.longPress(LongPressOptions.longPressOptions().withElement(ElementOption.element(LongPress))).perform();
